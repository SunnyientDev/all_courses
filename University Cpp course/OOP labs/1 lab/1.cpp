...
int main(){
  ...
  Object* RootObject = new Object(RootName); 
	
  Object* Object1, * Object2, * Object3, * PtrObject = 0;
    ...
    if (RootName == "endtree") break;
      ...
      int ClassNumber, ObjectState;
      string DerName;
			cin >> DerName >> ClassNumber >> ObjectState;
			
      if (RootName != RootObject->ObjectName)	PtrObject = RootObject->ObjectSearch(RootName);
			else PtrObject = RootObject;

			switch (ClassNumber){
			case 1:
				Object1 = new Class_2(DerName, PtrObject, ObjectState);
				break;
			case 2:
